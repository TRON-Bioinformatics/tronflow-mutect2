...
nextflow main.nf -profile test,conda --output $output --input_files test_data/test_input.txt --reference_version_funcotator hg19 --funcotator /flash/home/chritzel/sarcoma_analysis/exome/references/funcotator_dataSources.v1.6.20190124s/
